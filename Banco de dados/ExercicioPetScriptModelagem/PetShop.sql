...
insert into tbcliente values (null, 'Steve Tonino', '5664-7465', '99983-8972', 'Rua Projetada');

insert into tbCliente values
(null, 'Rebeca Marta', '5932-7182', '98561-8431', 'Rua da paz'),
(null, 'Maria Roberta', '5934-8925', '98647-2465', 'Rua cinco'),
(null, 'Stephani Villasboas', '5846-8436', '96942-5791', 'Rua amazônia preservada'),
(null, 'Mario Brok', '8756-4862', '92375-3457', 'Rua rebuscada'),
(null, 'Cléber Tonino', '5935-9461', '93476-1058', 'Rua Planejada');
...
select * from tbcliente order by endereço desc;
